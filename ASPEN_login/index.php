<?php
  ...
  $errorMessage="";
  //emailを残す用
  $viewEmail= htmlspecialchars($POST["email"], ENT_QUOTES);
...
<div class="form-wrapper">
  ...
  <form action="index.php" method="POST">
    <div><font size="1" color="red" value="<?php echo htmlspecialchars($_POST['name'], ENT_QUOTES, 'UTF-8'); ?>"></font></div>
    <div class="form-item">
    ...
    <div class="button-panel">
      <input type="submit" class="button" name="SignIn" value="Sign In"></input>
    </div>
  </form>
