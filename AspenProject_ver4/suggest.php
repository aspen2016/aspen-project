...
while($row = $search->fetch()){
    ...
    $timer++;
    if($timer>10 && $tmp_point > $tmp_sum/($timer*1.5)){
        continue;
    }
    $tmp_sum += $tmp_point;
  ...
  <div id = "container">
    ...
    <div id = "footer">
      <ul>
        ...
        <li><a class="footer_button" href="http://localhost/aspen3/suggest.php?pattern=<?php echo "$pattern"?>&id=<?php echo "$id"?>">再検索</a></li>
      </ul>
    </div>
</body>
</html>
