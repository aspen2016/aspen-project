...
<?php
    ...
    $selectdb = mysqli_select_db($CON,$DB_USER);
...
$search = $chose_shop->query("SET NAMES utf8");
...
<script type="text/javascript" src="http://maps.google.com/maps/api/js?key=AIzaSyDimNy5EQqYcTa8T7ChsIqUp68Weg4D6KE&sensor=true&language=ja"></script>
...
<script type="text/javascript" src="http://localhost/aspen0711/map_info2.js"></script>
  ...
  <div id = "container">
    ...
    <script type="text/JavaScript">
      ...
      <ul class="list_bottom">
        ...
        <li><a class="footer_button" href="http://localhost/aspen0711/suggest.php?pattern=<?php echo "$pattern"?>">再検索</a></li>
      </ul>
</body>
</html>
